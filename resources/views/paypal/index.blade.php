...
<head>
  ...
  <script src="https://www.paypal.com/sdk/js?client-id={{config('services.paypal.paypal_id')}}&components=buttons"></script>
...
/*       return fetch("/paypal/create/" + document.getElementById("paypal-amount").value)
    ...
    onApprove: function (data, actions) {
        return actions.order.capture().then(function (details) {
            ...
            // Enviar los detalles al servidor Laravel
            ...
            .then(data => {
                ...
                if (data.success) {
                    ...
                    alert('Hubo un problema procesando el pago en el servidor.');
                }
            });
        });
    }
