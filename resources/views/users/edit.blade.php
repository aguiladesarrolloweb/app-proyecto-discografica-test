<x-app-layout>
    <div class="flex justify-center items-center min-h-screen">
        <form action="{{ route('users.update', $user->id) }}" method="POST" id="user-create-form" class="w-full max-w-md">
            @csrf
            ...
            <div>
                <label for="password">Contraseña (dejar en blanco si no desea cambiarla): <span class="text-red-400">*</span></label>
            ...
            <div>
                <label for="role_id">Rol:<span class="text-red-400">*</span></label>
